  ...
  var actions = {
    ...
    openCart: function() {
      var subtotal = 0,
			cartHtml = '';
      cartData = actions.getStorage();
      orderPreview = '<p class="jqcart-cart-title">Ваш заказ: <span class="jqcart-print-order"></span></p><div class="jqcart-table-wrapper"><div class="jqcart-manage-order"><div class="jqcart-thead"><div>ID</div><div></div><div>Наименование</div><div>Цена</div><div>Кол-во</div><div>Сумма</div><div></div></div>';
      var key, sum = 0;
      for (key in cartData) {
        if (cartData.hasOwnProperty(key)) {
          ...
          orderPreview += '<div><span class="jqcart-incr plus" data-incr="1">+</span><input type="text" class="jqcart-amount" class="amount" value="' + cartData[key].count + '"><span class="jqcart-incr minus" data-incr="-1">&#8211;</span></div>';
